...
Description: Add a bubble while hovering user avatar with the information about this user, defined by admin on administration page. 
Version: 0.7
Author: slaFFik
Author URI: http://cosydale.com/
Site Wide Only: true
*/
define ( 'CD_PB_VERSION', '0.7' );
