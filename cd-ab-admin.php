        ...
        <table class="widefat link-group">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <ul>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('name', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="name" /> <?php _e('Group name', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('short_desc', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="short_desc" /> <?php _e('Short description', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('status', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="status" /> <?php _e('Group status', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('members', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="members" /> <?php _e('Number of members', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('join', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="join" /> <?php _e('Join/Leave group links', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('activity_date', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="activity_date" /> <?php _e('Latest activity date', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('feed_link', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="feed_link" /> <?php _e('Feed link (displayed if latest activity is checked)', 'cd_abb') ?></li>
                        <li><input type="checkbox" name="cd_ab_groups_data[]" <?php echo (in_array('forum_stat', $cd_ab['groups']['data'])?'checked="checked"':''); ?> value="forum_stat" /> <?php _e('Forum statistics (number of topics and posts)', 'cd_abb') ?></li>
                    </ul>
                </td>
            </tr>
